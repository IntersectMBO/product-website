...
| Experience| Builder Net Promoter Score|TBD| An off-chain, compound metric capturing builder net promoter score for different ecosystem participants including but not limited to; SPOs, tooling builders, core infrastructure developers and DeFi/other DApp developers | NPS of 4 or above for all segmented builders|Demonstrates the competitiveness of Cardano as a platform for developers|
...
- As part of the review of KPIs with the community we will build a strategy on how metrics are more effectively tracked and reported on, including supporting the creation of relevant dashboards.
- We will also review how KPIs and the related ‘Pillars’ strategy outlined below, can be referenced and standardized in treasury funding requests. This will support improved community evaluation and prioritisation.
